...
- `/query [type:X] {question}`: Filter by frontmatter `type` (see [schema.yaml](file:///LLM_Wiki_Project/schema.yaml)).
- `/query [tag:X] {question}`: Filter by frontmatter `tags` (see [taxonomy.md](file:///LLM_Wiki_Project/taxonomy.md)).
...
- **Reference**: Follow [01_architecture.md](file:///.agents/rules/01_architecture.md).
