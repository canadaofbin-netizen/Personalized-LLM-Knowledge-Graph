...
## Hard Rules
- **Taxonomy**: Cross-reference [taxonomy.md](file:///LLM_Wiki_Project/taxonomy.md) to use canonical tags.
- **Safety**: Follow [02_operations.md](file:///.agents/rules/02_operations.md) for data immutability.
...
- **Newsletter & Broadcast Filter**: Never extract automated mailing lists, newsletter bots, or broadcast notifications (e.g., `no-reply@*`, LMS notifications, community alerts, `notifications@*`) as `people` profiles. Record their contents under relevant projects or logs.
